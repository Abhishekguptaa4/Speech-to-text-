...
const recognition = new webkitSpeechRecognition(); // Use the webkitSpeechRecognition for Chrome compatibility

startListeningButton.addEventListener("click", () => {
  // Configure speech recognition settings
  recognition.continuous = true;
  recognition.lang = inputLanguageDropdown.querySelector(".selected").dataset.value; // Set the input language for recognition
